...
class _ProfilSellerPageState extends State<ProfilSellerPage> {
  final TextEditingController _emailController = TextEditingController(text: 'seller@email.com');
                      ...
                      CustomEmptyCard(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: const [
                              Text('Ika Fahriza', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              SizedBox(height: 4),
                              Text('Peran: Owner', style: TextStyle(fontSize: 15, color: Colors.grey)),
                            ],
                          ),
                        ),
                      ),
